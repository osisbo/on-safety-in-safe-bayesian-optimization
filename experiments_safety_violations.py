                ...
                for k in range(number_iterations_optimization):
                    ...
                    try:
                        ...
                        if k == number_iterations_optimization - 1:
                            ...
                            result_dict[style][7].append(current_regret_with_u)
                            result_dict[style][9].append(current_regret_with_l)
                        # print("Caught EnvironmentError('There are no safe points to evaluate.')")
...
if __name__ == "__main__":
    ...
    predefined_safe_seeds_02_2 = [1642692781]
    predefined_safe_seeds_02_20 = [1642665214]
    predefined_safe_seeds_05_2 = [1643060447]
    predefined_safe_seeds_05_20 = [1642696346]
    L_02_2 = 12
    L_02_20 = 119
    L_05_2 = 6
    L_05_20 = 57
